  ...
  >
    ...
    >
      ...
      >
        ...
        <p style="font-size: 16px; color: #4d4949;">We’re writing to confirm that your subscription plan has been successfully [upgraded/downgraded] to the [New Plan Name].</p>
		
			<p style="font-size: 14px; color: #4d4949;"><b>Here are the details of your new plan:</b></p>
			<p style="font-size: 14px; color: #4d4949;">New Plan: [New Plan Name]</p>
			<p style="font-size: 14px; color: #4d4949;">Price: [New Plan Price]</p>
