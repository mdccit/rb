  ...
  >
    ...
    >
      ...
      >
        ...
        <p style="font-size: 16px; color: #4d4949;">We wanted to let you know that your subscription to recruited has officially expired as of [Expiration Date]. This means you no longer have access to recruited.
        </p>
		
		 <p style="font-size: 14px; color: #4d4949;"><b>Final billing details </b></p>
		<p style="font-size: 14px; color: #4d4949;">Last Billing Date: [Last Billing Date]</p>
		<p style="font-size: 14px; color: #4d4949;">Amount Paid: [Amount Paid]</p>
	
      
        <br>
		
        <p  style="font-size: 12px; color: #4d4949;">
         you need assistance or believe this message was sent in error, feel free to reach out to us
        </p>
      </div>
