...
class BusinessManagersController extends Controller
{
    ...
    public function uploadProfilePicture(Request $request,$user_slug)
    {
        try{
            ...
            $responseData = $this->businessManagerService->uploadProfilePicture($request->file('file'),$user_slug);
    ...
    public function uploadCoverPicture(Request $request,$user_slug)
    {
        try{
            ...
            $responseData = $this->businessManagerService->uploadCoverPicture($request->file('file'),$user_slug);
    ...
    public function uploadMedia(Request $request,$user_slug)
    {
        try{
            ...
            $responseData = $this->businessManagerService->uploadMedia($request->file('files'),$user_slug);
    ...
    {
        try{
            $this->businessManagerService->removeMedia($media_id);
